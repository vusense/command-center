# Vusense Executive Decision Meta-Framework
...
**Repository hub:** [../../README.md](../../README.md) | **Operating model:** [../../README.md#operating-model](../../README.md#operating-model)
...
1. **New Decision?** Start with [03-state-gathering.md](./03-state-gathering.md) to complete the Decision Context Card
2. **Select Framework:** Use [04-framework-selection.md](./04-framework-selection.md) to choose the appropriate framework
3. **Apply Framework:** Use the corresponding template from [`./templates/`](./templates/)
4. **Document:** Record decision in the Decision Register
5. **Retrospect:** Complete retrospection if required (see [07-retrospection.md](./07-retrospection.md))
...
- **For active decision-making:** Jump to [03-state-gathering.md](./03-state-gathering.md)
- **For framework reference:** See [04-framework-selection.md](./04-framework-selection.md)
- **For investor due diligence:** Review [08-documentation-due-diligence.md](./08-documentation-due-diligence.md)
- **For quick lookup:** Use [11-quick-reference.md](./11-quick-reference.md)
